...
if (isset($_POST['Send'])) {
	...
	if ($send->verificar_email($email) == true) {
		...
		$temp_corpo = "<a href='localhost/Lammaaqui/reset_senha.php?tk='>localhost/Lammaaqui/reset_senha.php?tk=<?=?></a>";
		enviar_email($email, 'contato@llamaaqui.ml', 'Lamma Aqui', $assunto, $temp_corpo);
